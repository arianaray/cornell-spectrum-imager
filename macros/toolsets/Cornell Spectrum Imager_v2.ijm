...
// Icons contributed by Tony Collins.
  ...
  //var xx = requires138b(); // check version at install //Ariana edited here [original]
  var xx = requires154f(); //Ariana edited here
  //function requires138b() {requires("1.38b"); return 0; }
  function requires154f() {requires("1.38b"); return 0; }
...
function versionCheck() {
    //requires("1.41f"); //Ariana edited here [original]
	requires("1.54f"); 
    return 1;
}
...
macro "FFT Action Tool- icon:FFT_icon.png" {
